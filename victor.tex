...
\begin{document}
\name{Victor Gnanaraj}
\tagline{DevOps Engineer and Tech Enthusiast}
...
\begin{paracol}{2}
  ...
  \begin{itemize}
    \item Experienced Systems Engineer with 11+ Years of solid background in Linux, Kubernetes and VMware with focus on designing, implementing, and optimizing software delivery using CI/CD pipelines. Proficient in deploying and managing cloud/on-premise infrastructure, with expertise in monitoring and troubleshooting complex environments to enhance system stability and performance.
  \end{itemize}
\cvsection{Experience}

\cvevent{DevOps/WinOps Engineer}{Deriv}{Oct 2023 -- Ongoing}{Dubai, UAE}
\begin{itemize}
\item Led the \$5 billion acquisition of of the company with Verizon -- the entity which believed most in the immense value Yahoo!\ has created
\item Acquired Tumblr for \$1.1 billion and moved the company's blog there
\item Built Yahoo's mobile, vide1o and social businesses from nothing in 2011 to \$1.6 billion in GAAP revenue in 2015
...
\cvevent{System Administrator Specialist}{FIS}{Oct 2010 -- July 2012}{Chennai, India}
\begin{itemize}
...
\cvevent{Lead Systems Engineer}{Fidelity Investments}{2005 --  2010}{Palo Alto, CA}

\divider

\cvevent{Senior Analyst}{HCL Technologies}{Oct 2001 -- July 2005}{Palo Alto, CA}

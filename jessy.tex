...
\begin{paracol}{2}
  \cvsection{Summary}
  \begin{itemize}
  \item Seeking the position of a science teacher in an organization where I can employ my skills and knowledge to groom up the young generation in an innovative manner
  \end{itemize}
\cvsection{Education}
